...
+function ($) {
  ...
  Dropdown.prototype.keydown = function (e) {
    ...
    var $items = $parent.find('.dropdown-menu1' + desc)
  ...
  $(document)
    ...
    .on('keydown.bs.dropdown.data-api', '.dropdown-menu1', Dropdown.prototype.keydown)
...
+function ($) {
  ...
  Tab.prototype.activate = function (element, container, callback) {
    ...
    function next() {
      ...
      if (element.parent('.dropdown-menu1').length) {
        element
          .closest('li.dropdown')
            .addClass('active')
          .end()
